...
//           System.out.println("0 ms</div>");
        //Média incluindo chamadas resultantes em erro
        if (count[i] > 0)
    ...
    if (counts > 0)
    {
      System.out.print("<TR><TD><div align=left><B>"+ title +" Total</B></div><TD><div align=right><B>100 %</B></div><TD><div align=right><B>"+counts+
