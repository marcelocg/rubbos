...
public class RUBBoSProperties {
  ...
  private String servletServers;
  private int nbOfServletServers;
  ...
  /**
   * Creates a new <code>RUBBoSProperties</code> instance. If the
   * rubbos.properties file is not found in the classpath, the current thread is
   * killed.
   */
  public RUBBoSProperties() {
    ...
    try {
      ...
      servletServers = getProperty("servlets_server");
      nbOfServletServers = servletServers.contains(",") ? servletServers.split(",").length : 1;
      PHPHTMLPath = getProperty("php_html_path");
      PHPScriptPath = getProperty("php_script_path");

      StringTokenizer nodes = new StringTokenizer(
          getProperty("workload_remote_client_nodes"), ",");
      ...
      try {
        ...
        System.err.println("Unable to read dictionary file '" + storyDictionary
      ...
      System.err
          .println("No rubbos.properties file has been found in your classpath ("
  ...
  /**
   * Returns the value corresponding to a property in the rubbos.properties
   * file.
   * 
   * @param property
   *          the property name
  ...
  /**
   * Check for all needed fields in rubbos.properties and inialize corresponding
   * values.
   * 
   */
  public void checkPropertiesFile() {
    try {
      ...
      System.out.print("Servlet Server list : ");
      System.out.println(servletServers + "<br>");
      ...
      System.out.print("Number of clients per node     : ");
      System.out.println(nbOfClients + "<br>");
      ...
      if (useTPCWThinkTime)
        ...
        System.out
            .println("Using Transition Matrix think time information<br>");
   ...
   *  
   * @return returns null on any error or the URLGenerator corresponding to the
   *         configuration if everything was ok.
   */
  public URLGenerator getURLGen() {
  ...
  /**
   * Get the number of servlet servers
   * 
   * @return number of servlet servers
   */
  public int getNbOfServletServers() {
    return nbOfServletServers;
  }
  ...
  /**
   * Get the total number ofauthors given in the database_number_of_authors
   * field
   * 
  ...
  /**
   * Get the percentage of emulated users that should be authors (given in the
   * workload_percentage_of_author field)
   * 
  ...
  /**
   * Get the dictionary file used to build the stories. This file is a plain
  ...
  /**
   * Get the maximum story length given in the database_story_maximum_length
   * field
   * 
  ...
  /**
   * Get the year of the oldest story given in the database_oldest_story_year
   * field
   * 
  ...
  /**
   * Get the month of the oldest story given in the database_oldest_story_month
   * field
   * 
  ...
  /**
   * Get the user transition table file name given in the
   * workload_user_transition_table field
   * 
  ...
  /**
   * Get the author transition table file name given in the
   * workload_author_transition_table field
   * 
   * @return user transition table file name
   */
  ...
  /**
   * Returns true if TPC-W compatible think time must be used, false if
   * transition matrix think time has to be used.
   * 
  ...
  /**
   * Get the number of stories to display per page (when browsing) given in the
   * number_of_storis_per_page field
   * 
  ...
  /**
   * Get the monitoring debug level. Level is defined as follow:
   * 
   * <pre>
   * 0 = no debug message
